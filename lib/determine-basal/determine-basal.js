...
function getTddAdjustedMaxIob(profile, glucose_status, target_bg) {
    ...
    if (profile.enable_max_iob_deadbands) {
        ...
        if (currentBG >= 0 && currentBG < ((profile.tight_deadband_range / 100 * target_bg) + target_bg)) {
        ...
        } else if (currentBG >= ((profile.tight_deadband_range / 100 * target_bg) + target_bg) && currentBG <= ((profile.loose_deadband_range / 100 * target_bg) + target_bg)) {

...
// Print summary variables based on predBGs etc.
    ...
    if (profile.use_autosens_isf_to_calculate_auto_isf_sens){
        TddAdjustBasalreason = "Basal: " + round(profile.current_basal,2) + "\u2192" + round(getBasalValue(profile),2) + /* " (tddISF: " + convert_bg(1700 / profile.calculate_isf_from_tdd_numerator_divisor / (get24HrTDD (profile)),profile) +  "), " + */ ", " + "Autosens: " + round(autosens_data.ratio,2) + "(ISF: " + round(profile.sens / autosens_data.ratio,2) + ")" + ", ";
    }

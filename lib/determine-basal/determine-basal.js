...
// Print summary variables based on predBGs etc.
    ...
    let AutosensAdjustBasalreason = "Basal: " + round(profile.current_basal,2) + "\u2192" + round(getBasalValue(profile, autosens_data),2) + " (asISF: " + round(autosens_data.newisf,2) + "), " + "Autosens ratio: " + round(autosens_data.ratio,2) + ", ";

...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    let profileModifiedLiftISF;

        const baseLiftISF = liftISF;

        if (profile.low_carb_ez_fcl_profile) {
            final_ISF = ((baseLiftISF - 1) * profile.low_carb_ez_fcl_profile_multiplier) + 1;
        } else if (profile.moderate_carb_ez_fcl_profile) {
            final_ISF = ((baseLiftISF - 1) * profile.moderate_carb_ez_fcl_profile_multiplier) + 1;
        } else if (profile.high_carb_ez_fcl_profile) {
            final_ISF = ((baseLiftISF - 1) * profile.high_carb_ez_fcl_profile_multiplier) + 1;
        } else {

...
function getTddAdjustedMaxIob(profile, glucose_status, target_bg) {
    ...
    if (profile.enable_max_iob_deadbands) {
        const tightUpperLimit = profile.tight_deadband_range / 100 * target_bg;
        const looseUpperLimit = profile.loose_deadband_range / 100 * target_bg;

        if (currentBG >= 0 && currentBG < tightUpperLimit) {
        ...
        } else if (currentBG >= tightUpperLimit && currentBG <= looseUpperLimit) {
...
function getTddAdjustedMaxIobValue(profile, glucose_status, target_bg) {
    ...
    if (profile.enable_max_iob_deadbands) {
        ...
        } else if (currentBG >= tightUpperLimit && currentBG <= (profile.loose_deadband_range / 100 * target_bg)) {

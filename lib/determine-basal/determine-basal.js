...
function enable_smb(
    ...
    if (profile.sleep_mode === true && profiles.disable_mb_during_sleep || profile.automatic_sleep_mode === true && profiles.disable_mb_during_sleep) {
...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    isfreason += smbreason + calcreason + ", ezFCL";

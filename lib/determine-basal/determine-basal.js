...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    if ( sens_modified ) {
        ...
        isfreason += ppisfreason + deltaisfreason + duraisfreason + ", final Ratio: " + round(final_ISF,2) + exerciseReason + withinlimitsreason + ", final ISF: " + convert_bg(profile.sens, profile) + "\u2192" + convert_bg((profile.sens / autosens_data.ratio),profile) + "\u2192" + convert_bg(autoISFsens, profile);
        return autoISFsens;
    }
...
// Calculate sensitivityRatio based on temp targets, if applicable, or using the value calculated by autosens
    ...
    else if (typeof autosens_data !== 'undefined' && autosens_data && profile.enable_autosens && !profile.use_autoisf) {
...
// Initialize and calculate variables used for predicting BGs
    ...
    console.error("profile.sens:" + convert_bg((profile.sens / autosens_data.ratio),profile) +", sens:" + convert_bg(sens,profile) + ", CSF:" + round(csf,1));

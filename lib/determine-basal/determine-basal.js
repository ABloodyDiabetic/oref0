...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    if (bg_ISF<1) {
        ...
        isfreason += ", autosens-max " + round(profile.autosens_max,2) + ", final Ratio: " + round(final_ISF,2) + exerciseReason + withinlimitsreason + ", final ISF: " + convert_bg(profile.sens, profile) + "\u2192" + convert_bg((profile.sens / autosens_data.ratio),profile) + "\u2192" + convert_bg(autoISFsens, profile);
        return autoISFsens;

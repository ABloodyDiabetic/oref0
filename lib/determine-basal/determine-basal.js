...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    if (bg_ISF<1) {
        ...
        isfreason += ", final Ratio: " + round(final_ISF,2) + exerciseReason + withinlimitsreason + ", final ISF: " + convert_bg((profile.sens / autosens_data.ratio),profile) + "\u2192" + convert_bg(autoISFsens, profile);
        return autoISFsens;

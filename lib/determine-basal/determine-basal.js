...
// Begin core dosing logic: check for situations requiring low or high temps, and return appropriate temp after first match
    ...
    if (iob_data.iob > max_iob) {
        ...
        rT.reason = "Ins.Req: " + round(insulinReq,2) + ", " + "Basal: " + round(profile.current_basal,2) + "\u2192" + round(getBasalValue(profile, autosens_data),2) + " (asISF: " + round(autosens_data.newisf,2) + "), " + "Autosens ratio: " + round(autosens_data.ratio,2) + ", " + rT.reason;

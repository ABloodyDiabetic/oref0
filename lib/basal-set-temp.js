...
tempBasalFunctions.getMaxSafeBasal = function getMaxSafeBasal(profile, autosens_data) {
    ...
    return Math.min(profile.max_basal, (max_daily_safety_multiplier * adjustMaxSafeBasalInverselyToAutosensIsf(profile, autosens_data)) * profile.max_daily_basal, (current_basal_safety_multiplier * adjustMaxSafeBasalInverselyToAutosensIsf(profile, autosens_data)) * profile.current_basal);
};

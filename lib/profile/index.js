...
function defaults ( ) {
  return /* profile */ {
    ...
    , isfIntercept: 184.87
    , basalSlope: 0.0041
    , basalIntercept: 0.2593
    , sevenDayTDDPlaceholder: 20
    , twentyFourHrTDDPlaceholder: 20
...
function displayedDefaults () {
    ...
    profile.isfSlope = allDefaults.isfSlope;
    profile.isfIntercept = allDefaults.isfIntercept;
    profile.basalSlope = allDefaults.basalSlope;
    profile.basalIntercept = allDefaults.basalIntercept;
    profile.sevenDayTDDPlaceholder = allDefaults.sevenDayTDDPlaceholder;
    profile.twentyFourHrTDDPlaceholder = allDefaults.twentyFourHrTDDPlaceholder;
    profile.enableMiddleware = allDefaults.enableMiddleware;

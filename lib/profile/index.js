...
function displayedDefaults () {
    ...
    profile.max_daily_safety_multiplier = allDefaults.max_daily_safety_multiplier * adjustMaxSafeBasalInverselyToAutosensIsf(profile, autosens_data);
    profile.current_basal_safety_multiplier = allDefaults.current_basal_safety_multiplier * adjustMaxSafeBasalInverselyToAutosensIsf(profile, autosens_data);
